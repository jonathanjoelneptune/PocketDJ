      ...
      <aside id="menu2Panel" class="menu2-panel menu2-closed menu2-style-pocket menu2-art-large" aria-label="PocketDJ menu" aria-hidden="true">
        <div class="menu2-shell">
          ...
          <section id="menu2DevPane" class="menu2-pane menu2-dev-pane">
            ...
            <label class="menu2-setting">Fold fullscreen dock
              <select id="menu2FoldDockMode" class="menu2-select">
            ...
            <div class="menu2-dev-subsection">
              ...
              <label class="menu2-setting menu2-slider-setting">Camera X px <span id="menu2RoomCameraXValue">0.0</span>
                <input id="menu2RoomCameraX" type="range" min="-600" max="600" step="1" value="0" />
              </label>
              <label class="menu2-setting menu2-slider-setting">Camera Y px <span id="menu2RoomCameraYValue">0.0</span>
                <input id="menu2RoomCameraY" type="range" min="-600" max="600" step="1" value="0" />
              </label>
              <button id="menu2RoomCameraReset" class="menu2-action menu2-wide-action" type="button">Reset Room Camera</button>
            </div>
            <div class="menu2-dev-subsection">
...
export function updateLyricsCeiling(
  ...
  const manualLyricsDim = !lyricTest.active && !enabled;
  document.documentElement.classList.toggle("no-lyrics-paused-ceiling-dim", pausedCeilingDim);
  document.documentElement.classList.toggle("lyrics-manually-disabled-ceiling-dim", manualLyricsDim);
